...
1. git 설정
    ...
    readme 작성
    1. 글씨의 크기 : #을 입력하고 뒤에 글씨를 작성하면 커짐
                #은 연속 5개까지 입력가능. ##### << # (#갯수가 많을수록 작아짐)
    ...
    * 제목
    ...
    6. 이미지 추가
    issues에 드래그 해서 넣고 그거 복사해서 readme에 추가하면 됨
*/