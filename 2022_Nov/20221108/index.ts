...
// 이부분은 요청의 헤더에 (req.headers.authorization) authorization 값이
// userid = "chan", userpw = "1234" 정보를 가지고 요청한 사용자만 서버 조회 가능하도록 처리
...
app.listen(3000, () => {
    console.log("3000 포트 열림");
    ws.listen();
});

// ts-node 타입스크립트 노드 환경 실행
